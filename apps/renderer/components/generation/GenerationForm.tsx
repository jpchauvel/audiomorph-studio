    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full max-w-2xl mx-auto">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-end">
          <span
            className={`text-xs ${isPromptTooLong || promptLength > 1800 ? 'text-[var(--color-danger)]' : 'text-[var(--color-text-muted)]'}`}
          >
            {promptLength}/2000
          </span>
        </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between items-center">
          ...
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              toast.info('Lyrics workspace coming soon');
            }}
          >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="px-3 border-[var(--color-border)]"
            >
              🎲
            </Button>
          </div>
